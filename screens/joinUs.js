              ...
              <View style={styles.cardPairContainer}>
                ...
                >
                  <Card style={[styles.card, { backgroundColor: "#A9A9A9" }]}>
                    ...
                    >
                      <Image
                        source={require("../assets/onboarding/learning.png")}
                        style={styles.cardImage}
                      />
                      <Title
                        style={[styles.cardTitle, { fontFamily: "Droid" }]}
                      >
                        {" "}
                        {language === "ar" ? "مقدم كورسات" : "Course Provider"}
                      </Title>
                    </Animated.View>
                  </Card>
                </TouchableOpacity>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Image
                        source={require("../assets/onboarding/programmer.png")}
                        style={styles.cardImage}
                      />
                      ...
                      >
                        {" "}
                        {language === "ar" ? "مزود توصيات" : "Signal Provider"}
                      </Title>
                    </Animated.View>
                  </Card>
                </TouchableOpacity>
              ...
              <View style={styles.cardPairContainer}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Image
                        source={require("../assets/onboarding/clients.png")}
                        style={styles.cardImage}
                      />
                      <Title
                        style={[styles.cardTitle, { fontFamily: "Droid" }]}
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Image
                        source={require("../assets/onboarding/candlestick.png")}
                        style={styles.cardImage}
                      />
                      <Title
                        style={[styles.cardTitle, { fontFamily: "Droid" }]}
